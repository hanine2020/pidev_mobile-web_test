...
public class CongeA extends Form {
    ...
    public CongeA() {
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((tfMotifconge.getText().length() == 0) || (tfNbjourconge.getText().length() == 0)) {
                    ...
                    try {
                        Conge t = new Conge(tfMotifconge.getText(), Integer.parseInt(tfNbjourconge.getText()), (int) com.getSelectedItem());
        ...
        getToolbar().addMaterialCommandToLeftSideMenu("Acceuil", " ".charAt(0), w -> new HomeForm().show());
    }
